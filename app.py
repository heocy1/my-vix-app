...
with st.expander("ℹ️ 배율 기준 (S&P 500 기준)", expanded=False):
    st.markdown("""
    <div class="compact-table">

    | 단계 | 배율 | 조건 (VIX 또는 S&P 500) | 비고 |
    | :--- | :---: | :--- | :--- |
    | **평시** | **1.0x** | 기본 적립 상태 | 전고점 부근 |
    | **주의** | **1.2x** | 25↑ 또는 -5%↓ | 줍줍 시작 |
    | **공포** | **2.0x** | 30↑ 또는 -10%↓ | 비중 확대 |
    | **초공포**| **2.5x** | 40↑ 또는 -20%↓ | 과감한 매수 |
